...
namespace NFePHP\NFCom\Exception;
...
class DocumentsException extends \InvalidArgumentException implements ExceptionInterface
{
    public static $list = [
        ...
        1 => "O arquivo indicado como NFCom não está protocolado ou não é uma NFCom!!",
        ...
        7 => "Este xml não pertence ao projeto SPED-NFCom.",
        8 => "A configuração (config.json) não é válido {{msg}}.",
        9 => "Falta o CSC no config.json.",
        10 => "Falta o CSCId no config.json.",
        11 => "Falta a URL do serviço NFComConsultaQR.",
        12 => "O TXT não representa uma NFCom",
        ...
        15 => "Um TXT de NFCom deve ser passado como parâmetro, e nada foi passado.",
